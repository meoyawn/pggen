...
// Type is a Go type.
type Type interface {
	// Import returns the full package path, like "github.com/meoyawn/pggen/foo".
...
type (
	...
	ImportType struct {
		PkgPath string // fully qualified package path, like "github.com/meoyawn/pggen"
...
// "github.com/meoyawn/pggen/generate".
