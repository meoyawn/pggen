...
var (
	...
	PgCIDR             = MustParseKnownType("net/netip.Prefix", pg.CIDR)
	PgCIDRArray        = MustParseKnownType("[]net/netip.Prefix", pg.CIDRArray)
	...
	PgUnknown          = MustParseKnownType("string", pg.Unknown)
	...
	PgInet             = MustParseKnownType("net/netip.Addr", pg.Inet)
	PgBoolArray        = MustParseKnownType("[]bool", pg.BoolArray)
	PgByteaArray       = MustParseKnownType("[][]byte", pg.ByteaArray)
	PgInt2Array        = MustParseKnownType("[]int16", pg.Int2Array)
	PgInt4Array        = MustParseKnownType("[]int32", pg.Int4Array)
	PgTextArray        = MustParseKnownType("[]string", pg.TextArray)
	PgBPCharArray      = MustParseKnownType("[]string", pg.BPCharArray)
	PgVarcharArray     = MustParseKnownType("[]string", pg.VarcharArray)
	PgInt8Array        = MustParseKnownType("[]int64", pg.Int8Array)
	PgFloat4Array      = MustParseKnownType("[]float32", pg.Float4Array)
	PgFloat8Array      = MustParseKnownType("[]float64", pg.Float8Array)
	PgACLItem          = MustParseKnownType("string", pg.ACLItem)
	PgACLItemArray     = MustParseKnownType("[]string", pg.ACLItemArray)
	PgInetArray        = MustParseKnownType("[]net/netip.Addr", pg.InetArray)
	PgMacaddrArray     = MustParseKnownType("[]net.HardwareAddr", pg.MacaddrArray)
	...
	PgTimestampArray   = MustParseKnownType("[]github.com/jackc/pgx/v5/pgtype.Timestamp", pg.TimestampArray)
	PgDateArray        = MustParseKnownType("[]github.com/jackc/pgx/v5/pgtype.Date", pg.DateArray)
	PgTimestamptz      = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.Timestamptz", pg.Timestamptz)
	PgTimestamptzArray = MustParseKnownType("[]github.com/jackc/pgx/v5/pgtype.Timestamptz", pg.TimestamptzArray)
	PgInterval         = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.Interval", pg.Interval)
	PgNumericArray     = MustParseKnownType("[]github.com/jackc/pgx/v5/pgtype.Numeric", pg.NumericArray)
	...
	PgRecord           = MustParseKnownType("any", pg.Record)
	PgUUID             = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.UUID", pg.UUID)
	PgUUIDArray        = MustParseKnownType("[]github.com/jackc/pgx/v5/pgtype.UUID", pg.UUIDArray)
	PgJSONB            = MustParseKnownType("*string", pg.JSONB)
	PgJSONBArray       = MustParseKnownType("[]*string", pg.JSONBArray)
	PgInt4range        = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.Range[int32]", pg.Int4range)
	PgNumrange         = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.Range[float64]", pg.Numrange)
	PgTsrange          = MustParseKnownType("string", pg.Tsrange)
	PgTstzrange        = MustParseKnownType("string", pg.Tstzrange)
	PgDaterange        = MustParseKnownType("string", pg.Daterange)
	PgInt8range        = MustParseKnownType("github.com/jackc/pgx/v5/pgtype.Range[int64]", pg.Int8range)
)
...
// type and for cases where no native Go type is configured.
//
